...
<div class="contents" style="margin-top: 100px;">
    <div class="side-menu" style="position: fixed;">
        <ul>
            ...
            <li><a href="../filter"><img src="../../assets/img/icons/dropdown/filters.png" alt="">Appartment</a></li>
            <li><a href="../filter"><img src="../../assets/img/icons/dropdown/filters.png" alt="">Rent</a></li>
        </ul>
    </div>
    <div class="content" style="margin-left: 200px;">
    <div class="container-fluid" style="background-color: #ea4425;color:white;padding:10px"><h4> Add Property</h4></div>
    <div class="blog-content">
        ...
        <div style="box-shadow: inset 0px 0px 3px rgb(60 64 67 / 40%);background: #f3f3f3; border-radius:10px; padding: 10px;padding:20px;    width: 950px;" id="page-wrapper">
         ...
         <div class="form-group col-md-6 contact-info-div">
         <label>Name</label>
              <input class="form-control" type="text" name="name" value="unknown">
              <div class="title">Contact Informatiions*</div>
          </div><br><br><br>
         ...
         <div class="form-group col-md-6">
         <label>mail</label>
              <input class="form-control" type="email" name="mail" value="info@gmail.com">
          </div><br><br><br>
...
<div class="form-group ">
         <label>Content </label>
         <textarea name="txt" id="editor" style="width: 100%;" ></textarea>
          </div><br><br><br>
				 <!--...............blog..............-->
         <div class="container">
